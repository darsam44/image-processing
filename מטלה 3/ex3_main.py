...
def blendDemo():
    im1 = cv2.cvtColor(cv2.imread('galpagos_beach.jpg'), cv2.COLOR_BGR2RGB) / 255
    im2 = cv2.cvtColor(cv2.imread('big_turtle.jpg'), cv2.COLOR_BGR2RGB) / 255
    mask = cv2.cvtColor(cv2.imread('big_turtle_mask.jpg'), cv2.COLOR_BGR2RGB) / 255
